...
\csvstyle{renderbuildtimeTableStyle}{tabular=@{}lcccccccc@{},
table head=\toprule  & & \multicolumn{2}{c}{Killeroo Been} & \multicolumn{2}{c}{Sponza} & \multicolumn{2}{c}{Conference} \\ \cmidrule(r){3-4} \cmidrule(r){5-6} \cmidrule(r){7-8} Boom & K & R  & B & R  & B & R  & B\\ \midrule,
late after line=\\,
...
\csvstyle{intersectionsTableStyle}{tabular=@{}lcccccccc@{},
table head=\toprule  & & \multicolumn{2}{c}{Killeroo Been} & \multicolumn{2}{c}{Sponza} & \multicolumn{2}{c}{Conference} \\ \cmidrule(r){3-4} \cmidrule(r){5-6} \cmidrule(r){7-8} Boom & K & ZI & SI & ZI & SI & ZI & SI\\ \midrule,
late after line=\\,
late after last line=\\\bottomrule,
head to column names}
\begin{table}
  ...
  {$\type$ & \K & \num{\nbPrimIntTovKdFeet}\% & \num{\nbPrimIntPTovKdFeet}\% & \num{\nbPrimIntTovKdSponza}\% & \num{\nbPrimIntPTovKdSponza}\% & \num{\nbPrimIntTovKdConference}\% & \num{\nbPrimIntPTovKdConference}\% }% specify your coloumns here
...
\csvstyle{traversalsTableStyle}{tabular=@{}lcccccccc@{},
table head=\toprule  & & \multicolumn{2}{c}{Killeroo Been} & \multicolumn{2}{c}{Sponza} & \multicolumn{2}{c}{Conference} \\ \cmidrule(r){3-4} \cmidrule(r){5-6} \cmidrule(r){7-8} Boom & K & ZD & SD & ZD & SD & ZD & SD\\ \midrule,
late after line=\\,
late after last line=\\\bottomrule,
head to column names}
\begin{table}
...
\csvstyle{traversalsTableStyle}{tabular=@{}lccccccccccc@{},
table head=\toprule  & & \multicolumn{3}{c}{Killeroo Been} & \multicolumn{3}{c}{Sponza} & \multicolumn{3}{c}{Conference} \\ \cmidrule(r){3-5} \cmidrule(r){6-8} \cmidrule(r){9-11} Boom & K & $\symKd$ & ZD $\symKd$ & SD $\symKd$ & $\symKd$ & ZD $\symKd$ & SD $\symKd$ & $\symKd$ & ZD $\symKd$ & SD $\symKd$\\ \midrule,
late after line=\\,
late after last line=\\\bottomrule,
head to column names}
\begin{table}
