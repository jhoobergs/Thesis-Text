...
\section{Concept}
    ...
    Deze kindknopen bevatten alle driehoeken die (deels) in hun volume liggen. Figuur \ref{fig:traversal-bsp} toont een scene die opgesplitst is in twee kindknopen $k_1$ en $k_2$ door het oranje splitsingsvlak. Deze twee kindknopen zijn elk ook opgesplitst volgens een groen splitsingsvlak. 
